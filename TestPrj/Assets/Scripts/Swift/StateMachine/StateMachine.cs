...
namespace Swift
{
    ...
    public class StateMachine
    {
        ...
        // 状态集
        StableDictionary<string, State> states = new();
        List<StateTransition> allTrans = new();

        // 迁移集
        StableDictionary<string, List<StateTransition>> trans = new();
